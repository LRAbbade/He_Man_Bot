...
class Music:
    ...
    async def start(self, ctx):
        ...
        try:
            player = await state.voice.create_ytdl_player(song_url, ytdl_options=opts, after=state.toggle_next)
...
bot = commands.Bot(command_prefix=commands.when_mentioned_or('!'), description='I play he man forever')
